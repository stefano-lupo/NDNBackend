...
/*
 * A speed-improved simplex levels algorithm for 2D, 3D and 4D in Java.
 *
...
public class SimplexNoiseOctave {  // Simplex levels in 2D, 3D and 4D
    ...
    public double noise(double xin, double yin) {
        ...
        // Add contributions from each corner to get the final levels value.
    ...
    // 4D simplex levels, better simplex rank ordering method 2012-03-09
